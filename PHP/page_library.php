<?php
    ...
    // render ra những playlist ứng với từng user
    include('render/render_playlist_library.php');
...
<head>
    ...
    <!-- Những link dùng cho thư viện -->
    <?php
        include('../Link/link_library.php')
    ?>
</head>
<body>
    <!-- Khối bao tất cả -->
        ...
        <div class="containers container">
            ...
            <div class="content">
                ...
                <div class="content__playlist">
                    <h5 class="content__playlist-title">
                        PLAYLIST
                    </h5>
                ...
                <ul class="content__nav">
                    <li class="content__nav-items item--active">
                        BÀI HÁT
                        <div class="space"></div>
                    </li>
                    <li class="content__nav-items">
                        ALBUM
                        <div class="space"></div>
                    </li>
                </ul>
                <div class="content__block-tab">
                    <!-- Phần chứa nội dung của bài hát -->
                    <div class="content__block-tab-items item--active">
                        <ul class="content__block-tab-nav">
                            <li class="content__block-tab-nav-items item--active">
                                Yêu thích
                            </li>
                            <li class="content__block-tab-nav-items">
                                Đã tải lên
                            </li>
                        </ul>
                        <div class="content__block-tab-block">
                            <!-- Phần chứa nội dung của những bài hát yêu thích -->
                            <ul class="content__block-tab-content row item--active">
                                <?php if(!empty($user)) { ?>
                                    <?php if(!empty($newResultRenderLikeSong)){?>
                                        <?php for($i = 0; $i < count($newResultRenderLikeSong);$i++){?>
                                            <li class="content__block-tab-content-items col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                                <div class="content__block-tab-content-items-block">
                                                    <div style="background-image: url(<?php echo $newResultRenderLikeSong[$i]['songImage'] ?>);" class="content__block-tab-content-items-block-img"></div>
                                                    <div class="content__block-tab-content-items-block-blur"></div>
                                                    <div class="content__block-tab-content-items-block-icon">
                                                        <div title="Xóa khỏi thư viện" data-id="<?php echo $newResultRenderLikeSong[$i]['id'] ?>" class="content__block-tab-content-items-block-icon-items content__block-tab-content-items-block-icon-items--left">
                                                            <i class="icon ic-close icon--active"></i>
                                                        </div>
                                                ...
                                                <div class="content__block-tab-content-items-text">
                                                    <div class="content__block-tab-content-items-text-name-song">
                                                        <?php echo $newResultRenderLikeSong[$i]['songName'] ?>
                                                    </div>
                                                    <ul class="content__block-tab-content-items-text-artist">
                                                        <?php 
                                                            $arrayArtistName = explode(",", $newResultRenderLikeSong[$i]['artistName']);
                                    ...
                                    <?php } else {?>
                                        ...
                                        <li class="content__block-tab-content-no-song">
                                            <div class="content__block-tab-content-no-song-block">
                                                ...
                                                <span>Không có bài hát yêu thích nào</span>
                                            </div>
                                        </li>
                                    <?php }?>
                                <?php } else{?>
                            ...
                            <ul class="content__block-tab-content row">
                                ...
                                <li class="content__block-tab-content-no-song">
                                    <div class="content__block-tab-content-no-song-block">
                                        <i class="fa-solid fa-music"></i>
                                        <span>Không có bài hát nào được tải lên</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <!-- Phần chứa nội dung của ALBUM -->
                    <div class="content__block-tab-items">
