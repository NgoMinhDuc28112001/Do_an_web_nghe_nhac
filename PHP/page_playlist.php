<?php
    ...
    // render những bài hát có trong likesong chính là nằm trong thư viện
    include('render/render_likeSong.php');
    // render ra những bài hát có trong listeningUser
    include('render/render_listening.php');
    // Nhận id của từng playlist và render ra những thông tin của từng playlist
    include('render/render_inf_playList_User.php');
    // Render ra những bài hát ứng lới từng playlist
    include('render/render_songs_playlist.php');
...
<head>
    ...
    <!-- Link sử dụng cho trang playlist -->
    <?php
        include('../Link/link_playlist.php');
    ?>
</head>
<body>
    <!-- Khối bao tất cả -->
    <div class="apps">
        ...
        <div class="menu">
            ...
            <div class="menu__option">
                <ul class="menu__option-list">
                    ...
                    <li title="Thư viện" class="menu__option-items item--active">
                        <?php if(!empty($user)) { ?>
        ...
        <div class="containers container">
            ...
            <div class="content row">
                <!-- Phần bên trái trong content -->
                <div class="content__left">
                    <div class="content__left-block">
                        <?php if(isset($resultShowDataPlaylist['playlistImage'])) {?>
                            <div style="background-image: url(<?php echo $resultShowDataPlaylist['playlistImage']?>);" class="content__left-block-img"></div>
                        <?php } else{?>
                            <div style="background-image: url(../Image/no-img-playlist.png);" class="content__left-block-img"></div>
                        <?php }?>
                        <div class="content__left-block-blur"></div>
                        <div class="content__left-block-icon">
                            <div class="content__left-block-icon-items content__left-block-icon-items--left">
                                <i class="icon ic-close"></i>
                            </div>
                            <div class="content__left-block-icon-items content__left-block-icon-items--center content__left-block-icon-items--large">
                                <i class="icon ic-play-circle-outline"></i>
                            </div>
                            <div class="content__left-block-icon-items content__left-block-icon-items--right">
                                <i class="icon ic-add-play-now"></i>
                            </div>
                        </div>
                    </div>
                    <div class="content__left-text">
                        <h5 class="content__left-text-title">
                            <?php echo $resultShowDataPlaylist['playlistName']?>
                            <i title="Chỉnh sửa tên playlist" class="icon ic-edit"></i>
                        </h5>
                        <div class="content__left-text-user">
                            <span>Tạo bởi:</span> <?php echo $resultShowDataPlaylist['userName']?>
                        </div>
                    </div>
                </div>
                <!-- Phần bên phải trong content -->
                <div class="content__right">
                    <div class="content__right-title">
                        <h5>Bài hát trong playlist: <?php echo $resultShowDataPlaylist['playlistName']?></h5>
                    </div>
                    <?php if(!empty($newResultGetSongPlaylist)) { ?>
                        <div class="content__right-name-column">
                            <div class="content__right-name-column-left">
                                Tên bài hát và ca sĩ
                            </div>
                            <div class="content__right-name-column-center">
                                Thể loại
                            </div>
                            <div class="content__right-name-column-right"></div>
                        </div>
                        <?php for($i = 0; $i < count($newResultGetSongPlaylist); $i++) {?>
                            <div class="content__right-block">
                                <ul class="content__right-block-list">
                                    <li class="content__right-block-items">
                                        <div class="content__right-block-items-left">
                                            <div class="content__right-block-items-left-block">
                                                <div style="background-image: url(<?php echo $newResultGetSongPlaylist[$i]['songImage']?>);" class="content__right-block-items-left-block-img"></div>
                                                <div class="content__right-block-items-left-block-blur"></div>
                                                <div class="content__right-block-items-left-block-icon">
                                                    <i class="fa-solid fa-play"></i>
                                                </div>
                                            </div>
                                            <div class="content__right-block-items-left-text">
                                                <div class="content__right-block-items-left-text-nameSong">
                                                    <?php echo $newResultGetSongPlaylist[$i]['songName']?>
                                                </div>
                                                <div class="content__right-block-items-left-text-nameArtist">
                                                    <?php
                                                        $arrayArtistName = explode(",", $newResultGetSongPlaylist[$i]['artistName']);
                                        ...
                                        <div class="content__right-block-items-center">
                                            <?php echo $newResultGetSongPlaylist[$i]['kindMusic']?>
                                        </div>
                                        <div class="content__right-block-items-right">
                                            <div class="content__right-block-items-right-items">
                                                <i class="fa-regular fa-heart"></i>
                                            </div>
                                            <div class="content__right-block-items-right-items">
                                                <i class="icon ic-add-play-now"></i>
                                            </div>
                                            <div class="content__right-block-items-right-items item--deletePlaylist">
                                                <i title="Xóa bài hát khỏi playlist" data-id-song="<?php echo $newResultGetSongPlaylist[$i]['id']?>" data-id-playlist="<?php echo $resultShowDataPlaylist['id']?>" data-name-playlist="<?php echo $resultShowDataPlaylist['playlistName']?>" class="icon ic-close"></i>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <?php }?>
                    <?php } else{?>
                        <div class="content__right-block--no-songs">
                            <i class="fa-solid fa-music"></i>
                            <span>Không có bài hát nào trong playlist này</span>
                        </div>
                    <?php }?>
                    <div class="content__right-suggest-title">
                        <h5>
                            Bài hát hợi ý: <span>Dựa trên các bài hát được nghe từ 2 lần trở lên</span>
                        </h5>
                        <div class="content__right-suggest-title-update">
                            <i class="icon ic-reload"></i>
                            <span>Làm mới</span>
                        </div>
                    </div>
                    <div class="content__right-block">
                        <ul class="content__right-block-list">
                            <?php for($i = 0;$i < count($newResultRenderListening);$i++) {?>
                                <li class="content__right-block-items">
                                    <div class="content__right-block-items-left">
                                        <div class="content__right-block-items-left-block">
                                            <div style="background-image: url(<?php echo $newResultRenderListening[$i]['songImage']?>);" class="content__right-block-items-left-block-img"></div>
                                            <div class="content__right-block-items-left-block-blur"></div>
                                            <div class="content__right-block-items-left-block-icon">
                                                <i class="fa-solid fa-play"></i>
                                            </div>
                                        ...
                                        <div class="content__right-block-items-left-text">
                                            <div class="content__right-block-items-left-text-nameSong">
                                                <?php echo $newResultRenderListening[$i]['songName']?>
                                            </div>
                                            <div class="content__right-block-items-left-text-nameArtist">
                                                <?php
                                                    $arrayArtistName = explode(",", $newResultRenderListening[$i]['artistName']); 
                                                    foreach($arrayArtistName as $artistName)
                                                    {
                                                        echo $artistName;
                                                    }
                                    ...
                                    <div class="content__right-block-items-center">
                                        <?php echo $newResultRenderListening[$i]['kindMusic']?>
                                    </div>
                                    <div class="content__right-block-items-right">
                                        <div class="content__right-block-items-right-items">
                                            <i class="fa-regular fa-heart"></i>
                                        ...
                                        <div class="content__right-block-items-right-items item--addPlaylist">
                                            <i title="Thêm bài hát vào playlist" data-name-playlist="<?php echo $resultShowDataPlaylist['playlistName']?>" data-id-song="<?php echo $newResultRenderListening[$i]['id']?>" data-id-playlist="<?php echo $resultShowDataPlaylist['id']?>" class="fa-solid fa-plus"></i>
                                        </div>
                                    </div>
                                </li>
                            <?php }?>
...
<!-- Hàm xử lý delete playlist bằng ajax -->
<script src="../JS/handle_delete_playlist_ajax.js"></script>
<!-- Hàm xử lý delete song trong likesong bằng ajax -->
<script src="../JS/handle_delete_likeSong_ajax.js"></script>
<!-- Hàm xử lý thêm bài hát vào playlist bằng gợi ý -->
<script src="../JS/handle_add_songs_playlist_ajax.js"></script>
<!-- Hàm xử lý xóa bài hát khỏi playlist -->
<script src="../JS/handle_delete_songs_playlist_ajax.js"></script>
<!-- Hàm xử lý page UI cho library-->
<script src="../JS/handle_page_UI_library.js"></script>
</html>